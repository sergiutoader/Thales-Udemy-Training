package behavioral.strategy.codingexercise;
...
class QuadraticEquationSolver
{
    ...
    public Pair<Complex, Complex> solve(double a, double b, double c)
    {
        ...
        double sqrtDiscriminant = discriminant >= 0 ?  Math.sqrt(discriminant): Math.sqrt(-discriminant);
        Complex c1, c2;
        if (discriminant < 0) {
            c1 = new Complex(-b / (2 * a), sqrtDiscriminant / (2 * a));
            c2 = new Complex(-b / (2 * a), - sqrtDiscriminant / (2 * a));
        } else {
            c1 = new Complex((-b + sqrtDiscriminant) / (2 * a), 0);
            c2 = new Complex((-b - sqrtDiscriminant) / (2 * a), 0);
        }
